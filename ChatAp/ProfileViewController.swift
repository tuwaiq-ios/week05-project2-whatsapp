...
class ProfileViewController: UIViewController , UITextFieldDelegate {
    ...
    let profileImage: UIImageView = {
        ...
        pI.tintColor = .gray
//        pI.tintColor = UIColor(red: (152/255), green: (138/255), blue: (161/255), alpha: 1)
        pI.layer.masksToBounds = true
        pI.layer.borderWidth = 2
        pI.layer.borderColor = UIColor(red: (69/255), green: (38/255), blue: (51/255), alpha: 1).cgColor
        return pI
    }()
     ...
     let signOutButton: UIButton = {
       ...
       signOutButton.setTitle("sign out", for: .normal)
        signOutButton.setTitleColor(.white, for: .normal)
         signOutButton.backgroundColor = UIColor(red: (69/255), green: (38/255), blue: (51/255), alpha: 1)
