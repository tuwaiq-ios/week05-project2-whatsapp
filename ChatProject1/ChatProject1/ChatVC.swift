...
class ChatVC: UIViewController {
    ...
    func setupUI() {
        ...
        navigationItem.title = contacts?.name
...
extension ChatVC {
    @objc func sendMessage() {
        ...
        guard let user = contacts else {return}
    ...
    func getAllMessages() {
        Firestore.firestore().collection("Messages").whereField("reciever", isEqualTo: contacts?.userID).addSnapshotListener { snapshot, error in
