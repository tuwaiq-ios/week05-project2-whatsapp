...
//  ChattingApp
//
//  Created by Abdulaziz on 24/03/1443 AH.
//
...
//        if let email = emailTextField.text, email.isEmpty == false, let password = passwordTextField.text, password.isEmpty == false, let name = nameTextField.text, name.isEmpty == false {
//
//
