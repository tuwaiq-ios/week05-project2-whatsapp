...
class DirectMessageScreen: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        //dELETES IMAGE NEXT TO CHAT CELL
    ...
    private func writeData(userNewText: String) {
        ...
        db.collection("Messages").addDocument(data: [
            ...
            if let e = error {
                ...
                DispatchQueue.main.async {
#warning("check if we need these")
...
extension DirectMessageScreen: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate{
    ...
    //changes cell back ground colors
    func backgroundColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor {
             return isFromCurrentSender(message: message) ? UIColor(#colorLiteral(red: 0.25, green: 0.35, blue: 50, alpha: 1)) : UIColor(#colorLiteral(red: 30, green: 0.80, blue: 20, alpha: 1))
     }
